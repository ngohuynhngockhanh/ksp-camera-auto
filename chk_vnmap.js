...
(async () => {
  ...
  await p.goto('https://apphub.a.vnmap3d.io.vn/citizen', {waitUntil:'networkidle'});
  ...
  await p.screenshot({path:'/tmp/vnmap_samples_desktop.png', fullPage:false});
  ...
  await p.screenshot({path:'/tmp/vnmap_samples_answer.png', fullPage:false});
  // mobile
  const m = await b.newPage({viewport:{width:390,height:844}});
  await m.goto('https://apphub.a.vnmap3d.io.vn/citizen', {waitUntil:'networkidle'});
  ...
  await m.screenshot({path:'/tmp/vnmap_samples_mobile.png', fullPage:false});
  await b.close();
})();
