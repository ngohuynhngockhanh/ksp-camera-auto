...
related: [dong-lenh, cau-hinh-yaml, shinobi-nvr]
---
## Mục đích

Máy chủ **Model Context Protocol (MCP)** nhúng trực tiếp trong `kspcam` cung cấp bộ 23+ công cụ chuẩn hóa (qua JSON-RPC 2.0) giúp các trợ lý AI (như Antigravity, Claude Desktop, Cursor, Hermes, ChatGPT) trực tiếp dò tìm, cấu hình, chẩn đoán hệ thống camera IP đa hãng (Dahua/KBVision, Hikvision, Tiandy) và điều khiển Shinobi NVR.
